...
var cnItems = {
    ...
    "\n        No save exists on": "\n 暂无存档",
    "* If you have made purchases, you keep unlocks like faster ticks, but lose consumed items like 奖励tick ": "* 如果您进行了购买，您会像更快的tick一样保持解锁状态，但会丢失已消耗的物品，如奖励tick",
    ...
    "Explosives": "炸药",
    "Guns": "枪",
    "All components output": "所有组件输出",
    "Allows tanks production": "允许生产坦克",
    "aluminium": "铝",
    "Aluminium buyer": "铝购买者",
    "Amount of resources produced": "生产资源量",
    "Electronics production will not produce waste": "电子产品生产不会产生废物",
    "engine": "发动机",
    "Engine maker": "发动机制造商",
    "Engine seller": "发动机出售者",
    "Makes conveyors much more effective, as they transport more resources.": "使传送带更有效，因为它们输送更多的资源。",
    "More production per component with less raw materials, but expenses are proportionally the same. More production per component => more resources to sell.": "用更少的原材料生产更多的每个组件，但费用成比例地相同。 每个组件的产量增加 => 可销售的资源更多。",
    "more resources into single package.": "将更多资源整合到一个包中。",
    "Package size": "整合包大小",
    "produces": "生产",
    "Rocket assembler": "火箭组装工",
    "Rocket assembly": "火箭组装",
    "rocket hull": "火箭壳",
    "Rocket hull maker": "火箭壳制造商",
    "Rocket warhead maker": "火箭弹头制造商",
    "tank": "坦克",
    "Tank assembler": "坦克装配工",
    "Tank assembly": "坦克组装",
    "Tank hull": "坦克壳",
    "tank hull": "坦克壳",
    "Tank hull maker": "坦克壳制造商",
    "tank turret": "坦克炮塔",
    "Tank turret maker": "坦克炮塔出售者",
    "Tank seller": "坦克出售者",
    "Warhead maker": "弹头制造商",
    "warhead": "弹头",
    "Warhead": "弹头",
    "rocket": "火箭",
    "Jet fuel refinery": "喷气燃料精炼厂",
    "Engine makers production will not produce waste": "发动机制造商生产不会产生废物",
    "Engine": "发动机",
    "Diesel refinery": "柴油精炼厂",
    "Diesel increases tanks value.": "柴油增加坦克价值。",
    "Bonus": "奖励",
    "Alu": "铝",
    "Allows producing rockets": "允许生产火箭",
    "Allows producing drones": "允许生产无人机",
    "adds": "添加",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Clean electronics": "清洁电子产品",
    "Tank components": "坦克组件",
    "Rocket components": "火箭组件",
    "Quality center": "质量中心",
    "Clean engines": "清洗发动机",
    "Diesel refinery": "柴油精炼厂",
    "Drone components": "无人机组件",
    "": "",
    "": "",
    "": "",
    "": "",
